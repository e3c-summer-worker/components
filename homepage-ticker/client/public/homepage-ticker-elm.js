...
var $author$project$HomepageTicker$GotContent = function (a) {
	return {$: 'GotContent', a: a};
};
var $author$project$HomepageTicker$Loading = {$: 'Loading'};
var $author$project$Data$Content$Content = F2(
...
var $author$project$Data$Content$decode = A3(
	...
	A3(
		...
		'english',
		$elm$json$Json$Decode$string,
		$elm$json$Json$Decode$succeed($author$project$Data$Content$Content)));
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Data$Content$decodeList = $elm$json$Json$Decode$list($author$project$Data$Content$decode);
...
var $author$project$HomepageTicker$init = function (_v0) {
	return _Utils_Tuple2(
		$author$project$HomepageTicker$Loading,
		$elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, $author$project$HomepageTicker$GotContent, $author$project$Data$Content$decodeList),
				url: 'https://4y7qfk.deta.dev/content'
			}));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$HomepageTicker$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$HomepageTicker$Error = function (a) {
	return {$: 'Error', a: a};
};
var $author$project$HomepageTicker$Success = function (a) {
	return {$: 'Success', a: a};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$HomepageTicker$update = F2(
	function (msg, model) {
		...
		if (_v0.a.$ === 'Loading') {
			...
			if (result.$ === 'Ok') {
				...
				return _Utils_Tuple2(
					$author$project$HomepageTicker$Success(content),
					$elm$core$Platform$Cmd$none);
			} else {
				var error = result.a;
				return _Utils_Tuple2(
					$author$project$HomepageTicker$Error(error),
					$elm$core$Platform$Cmd$none);
			}
		} else {
...
var $author$project$HomepageTicker$viewContent = function (content) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('ticker-item')
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(content.english)
			]));
};
var $author$project$HomepageTicker$viewError = function (error) {
	switch (error.$) {
		case 'BadUrl':
			var str = error.a;
			return A2(
		...
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Bad body'),
						$elm$html$Html$text(str)
					]));
	}
};
var $author$project$HomepageTicker$view = function (model) {
	switch (model.$) {
		case 'Loading':
			return A2(
				$elm$html$Html$div,
		...
		case 'Error':
			...
			return A2(
				...
				_List_fromArray(
					[
						$author$project$HomepageTicker$viewError(error)
					]));
		default:
				...
				A2(
					...
					function (content) {
						return A2(
							...
							_List_fromArray(
								[
									$author$project$HomepageTicker$viewContent(content)
								]));
					},
					contents));
	}
};
var $author$project$HomepageTicker$main = $elm$browser$Browser$element(
	{init: $author$project$HomepageTicker$init, subscriptions: $author$project$HomepageTicker$subscriptions, update: $author$project$HomepageTicker$update, view: $author$project$HomepageTicker$view});
_Platform_export({'HomepageTicker':{'init':$author$project$HomepageTicker$main(
